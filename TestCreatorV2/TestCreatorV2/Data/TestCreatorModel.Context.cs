...
namespace TestCreatorV2.Data
{
    ...
    public partial class TestCreatorEntities : DbContext
    {
        ...
        public virtual ObjectResult<AllUsersConteiner> GetAllUsers()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<AllUsersConteiner>("GetAllUsers");
        }
    
        public virtual int AktualizacjaUzytkownika(Nullable<long> idUzytkownika, string login, string name, string haslo, Nullable<long> id_rola)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AktualizacjaUzytkownika", idUzytkownikaParameter, loginParameter, nameParameter, hasloParameter, id_rolaParameter);
        }
    }
}
